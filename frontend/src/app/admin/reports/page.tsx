      ...
      <div className="mb-6">
        <div className="flex items-center gap-3 mb-1">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">Generate and view platform reports</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        <div className="rounded-xl overflow-hidden" style={{ background: '#161b22', border: '1px solid rgba(255,255,255,0.04)' }}>
          <div className="px-5 py-4 border-b border-white/[0.06]">
            <h2 className="text-sm font-bold text-gray-100 uppercase tracking-wider">Available Reports</h2>
          </div>
          <div className="divide-y divide-white/[0.04]">
            {items.map((r) => (
              <div key={r.id} className="px-5 py-4 hover:bg-white/[0.02] transition flex items-center justify-between">
                <div>
                ...
                <div className="flex items-center gap-3 shrink-0">
                  <span className="text-[10px] font-medium px-2 py-0.5 rounded-full capitalize"
                    style={{ background: `${BRAND.navy}60`, color: '#8b949e' }}>{r.type}</span>
        ...
        <div className="rounded-xl p-6" style={{ background: '#161b22', border: '1px solid rgba(255,255,255,0.04)' }}>
          <h2 className="text-sm font-bold text-gray-100 uppercase tracking-wider mb-4">Custom Report</h2>
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3">
                {['PDF', 'CSV', 'Excel'].map((f) => (
                  <label key={f} className="flex items-center gap-1.5 text-sm" style={{ color: '#8b949e' }}>
