            ...
            <div className="space-y-3 text-sm">
              ...
              {detail.photo_url && (
                <div><span className="text-gray-600">Photo:</span><br/>
                  <AppImage src={`${BASE_URL}${detail.photo_url}`} alt="" className="w-20 h-20 rounded-full object-cover mt-1 border border-gray-200" />
                </div>
              )}
              ...
              {loading ? (
                ...
                <tr key={c.id} className="hover:bg-gray-50 transition">
                  ...
                  <td className="px-4 py-3.5 text-center">
                    {c.photo_url ? (
                      <AppImage src={`${BASE_URL}${c.photo_url}`} alt="" className="w-8 h-8 rounded-full object-cover border border-gray-200 mx-auto" />
