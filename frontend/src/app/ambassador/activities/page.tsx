...
const allActivities = [
  { action: 'You joined the Ambassador Program', time: '2 minutes ago', icon: '🎉', type: 'achievement' },
  { action: 'Referral code copied to clipboard', time: '1 hour ago', icon: '📋', type: 'action' },
  { action: 'Profile updated successfully', time: '3 hours ago', icon: '👤', type: 'action' },
  { action: 'Welcome bonus received: 100 🪙', time: '1 day ago', icon: '🪙', type: 'reward' },
];
            ...
            {filtered.map((a, i) => (
              <div key={i} className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className="w-9 h-9 rounded-full flex items-center justify-center text-base shrink-0" style={{ background: '#f0f2f9' }}>{a.icon}</div>
