    ...
    <div style={{ background: '#f5f6fa', minHeight: '100vh' }}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
          {[
            { label: 'Total Users',    value: stats?.totalUsers ?? 0,     icon: '👤', bg: '#1a2b6d', light: '#e8ecf8' },
            { label: 'Active Listings',value: stats?.activeListings ?? 0, icon: '📋', bg: '#FF6B00', light: '#fff3ec' },
            { label: 'Total Connects', value: stats?.totalUnlocks ?? 0,   icon: '📞', bg: '#7c3aed', light: '#f5f0ff' },
            { label: 'Coins Revenue',  value: totalRevenue,               icon: '🪙', bg: '#059669', light: '#ecfdf5' },
          ].map((card) => (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-8">
          {[
            { href: '/staff/users',    label: 'Manage Users',    icon: '👥' },
            { href: '/staff/listings', label: 'Manage Listings', icon: '🏪' },
            { href: '/staff/promos',   label: 'Promo Codes',     icon: '🎟️' },
            { href: '/listings/create',label: 'Post Listing',    icon: '➕' },
          ].map((item) => (
