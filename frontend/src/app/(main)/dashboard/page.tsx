      ...
      <div className="max-w-6xl mx-auto px-4 py-8 flex gap-6">
          ...
          <div className="px-6 pb-6 -mt-12">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mt-4">
              <div className="rounded-xl p-4 text-center border border-gray-100" style={{ background: '#fff7ed' }}>
                ...
                <p className="text-2xl font-extrabold" style={{ color: ORG }}>🪙 {(user.coins ?? 0).toLocaleString()}</p>
              </div>
        ...
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              { icon: '🪙', label: 'Coins',         val: (user.coins ?? 0).toLocaleString() },
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-sm font-bold uppercase tracking-widest" style={{ color: NAVY }}>🏅 Ambassador Program</h2>
