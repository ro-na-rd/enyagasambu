...
export default function VerifySupplierCertificatePage() {
  ...
  useEffect(() => {
    const verifyCertificate = async () => {
      try {
        const { data } = await api.get(`/supplier/certificate/verify/${certNo}`);
        setResult(data);
      } catch (err: unknown) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Verifying supplier certificate...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Supplier Certificate Verification</h1>
        ...
        {error ? (
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 border border-green-200">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-green-900">Valid Supplier Certificate</h2>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Supplier Name</p>
                  <p className="font-semibold text-gray-900">{result.certificate.supplier_name}</p>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                ...
                {result.certificate.business_name && (
                  <div className="bg-gray-50 rounded-lg p-4">
                    <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Business Name</p>
                    <p className="font-semibold text-gray-900">{result.certificate.business_name}</p>
                  </div>
                )}
                <div className="bg-gray-50 rounded-lg p-4">
              ...
              {result.certificate.supplier_phone && (
                <div className="bg-gray-50 rounded-lg p-4">
                  <p className="text-xs text-gray-500 uppercase tracking-wide mb-1">Contact Phone</p>
                  <p className="font-semibold text-gray-900">{result.certificate.supplier_phone}</p>
                </div>
              )}
              ...
              {result.certificate.is_expired && (
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                  <p className="text-sm text-yellow-800">
                    <strong>Note:</strong> This certificate has expired. Please contact the supplier or our support team for renewal information.
                  </p>
                </div>
              )}
            </div>
